...
class _AdminHomeState extends State<AdminHome> {
  final List<Map<String, String>> bookingStatus = [
    ...
    {'code': 'XX', 'name': 'Cancelled'},
  ];

  String selectedBookingStatus = 'P';
  List<LocationModel> locations = [];
  Future<void> showAdminCancelConfirmationDialog(
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          ...
                          child: Text(
                            AppLocalizations.of(context)?.keepBooking ??
                                'Keep Booking',
      ...
      listeners: [
        ...
        BlocListener<AdminBloc, AdminState>(
          listener: (context, state) {
            ...
            } else if (state is OrderCancellationError) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(
                    AppLocalizations.of(context)?.failedToCancelOrder ??
                        'Failed to cancel order: ${state.error}',
                  ),
                  backgroundColor: Colors.red,
                ),
              );
                        ...
                        return ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return BookingCards(
                              ...
                              onCancel: () {
                                showAdminCancelConfirmationDialog(
                                  context,
                                  booking,
                                  () {
                                    // Trigger the AdminCancelOrderEvent
                                    context.read<AdminBloc>().add(
                                      AdminCancelOrderEvent(booking: booking),
                                    );
                                  },
                                );
                              },
